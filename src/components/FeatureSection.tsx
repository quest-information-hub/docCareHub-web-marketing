...
import {
  User, Users, Calendar, MessageSquare, FileText, Bell,
  Book, ChartBar, Settings, Shield, Lock, Eye,
  LucideIcon
} from "lucide-react";
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col">
        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-b from-medical-500 to-blue-600 p-[2px] rounded-b-2xl rounded-tr-2xl animate-fade-in" 
               style={{ animationDuration: '0.4s' }}>
            {/* Glow effect at the top of the content */}
            <div className="absolute top-0 left-0 w-full h-8 bg-gradient-to-r from-medical-500/50 to-blue-600/50 blur-md" />
            
            {/* Content background */}
            <div className="bg-gray-100/90 backdrop-blur-sm p-8 rounded-b-xl rounded-tr-xl">
